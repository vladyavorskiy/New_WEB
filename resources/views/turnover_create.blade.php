            ...
            <form method="post" action={{url('turnover')}} >
                    ...
                    <select class="form-select" id="country1" name="country1_id" aria-describedby="countryHelp" value={{ old('country1_id') }} >
                        ...
                        @foreach ($countries as $country)
                            <option value="{{$country->id}}"
                                    @if(old('country1_id') == $country->id) selected
                                @endif>{{$country->name}}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" id="country2" name="country2_id" aria-describedby="countryHelp" value={{ old('country2_id') }} >
                        ...
                        @foreach ($countries as $country)
                            <option value="{{$country->id}}"
                                    @if(old('country2_id') == $country->id) selected
                                @endif>{{$country->name}}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error("export_from1_to2") is-invalid @enderror"
                           id="export_from1_to2" name="export_from1_to2" aria-describedby="export_from1_to2Help" value={{old('export_from1_to2') }}>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error("export_from2_to1") is-invalid @enderror"
                           id="export_from2_to1" name="export_from2_to1" aria-describedby="export_from2_to1Help" value={{old('export_from2_to1') }}>
