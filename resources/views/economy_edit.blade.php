...
{{--    <br><br>--}}
{{--    <label>Год</label>--}}
{{--    <input type="date" name="year" value="{{ old('year') ?: $economy->year }}"/>--}}
{{--    @error('year')--}}
{{--    <div class="is-invalid">{{$message}}</div>--}}
{{--    @enderror--}}
{{--    <br><br>--}}
{{--    <label>ВВП</label>--}}
{{--    <input type="text" name="GDP" value="@if (old('GDP')) {{old('GDP')}} @else {{$economy->GDP}} @endif"/>--}}
{{--    @error('GDP')--}}
{{--    <div class="is-invalid">{{$message}}</div>--}}
{{--    @enderror--}}
{{--    <br><br>--}}
{{--    <label>ВВП/чел</label>--}}
{{--    <input type="text" name="date" value="@if (old('GDP_person')) {{old('GDP_person')}} @else {{$economy->GDP_person}} @endif"/>--}}
{{--    @error('GDP_person')--}}
{{--    <div class="is-invalid">{{$message}}</div>--}}
{{--    @enderror--}}
{{--    <br><br>--}}
            ...
            <form method="post" action={{url('economy/update/'.$economy->id)}}>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" min="1900" max="2099" class="form-control @error("year") is-invalid @enderror"
                           id="year" name="year" aria-describedby="yearHelp" value="{{ old('year') ?: $economy->year }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error("GDP") is-invalid @enderror"
                           id="GDP" name="GDP" aria-describedby="GDPHelp"
                           value="@if (old('GDP')) {{old('GDP')}} @else {{$economy->GDP}} @endif">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error("GDP_person") is-invalid @enderror"
                           id="GDP_person" name="GDP_person" aria-describedby="GDP_personHelp"
                           value="@if (old('GDP_person')) {{old('GDP_person')}} @else {{$economy->GDP_person}} @endif">
